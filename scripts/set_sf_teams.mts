...
const SF: Array<{ api_fixture_id: number; home_team: string; away_team: string }> = [
  { api_fixture_id: 20260102, home_team: 'England', away_team: 'Argentina' },
]
...
console.log(`\nDone. Updated ${SF.length} SF rows.`)
